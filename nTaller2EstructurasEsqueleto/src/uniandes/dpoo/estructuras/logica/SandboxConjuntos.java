...
public class SandboxConjuntos
{
    ...
    {
    	List<String> setalista = new ArrayList<String>(arbolCadenas);
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    	...
    	List<String> inverso_set_lista = new ArrayList<String>(arbolCadenas.descendingSet());
        return inverso_set_lista;
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	NavigableSet<String> nuevo_arbolCadenas = new TreeSet<String>( );
    	
    	for (String cadena: arbolCadenas) {
    		nuevo_arbolCadenas.add(cadena.toUpperCase());
    	}
    	
    	arbolCadenas.clear();
    	arbolCadenas.addAll(nuevo_arbolCadenas);
    ...
    public TreeSet<String> invertirCadenas( )
    {
    	...
    	Comparator<String> comparadorInvertido = Comparator.reverseOrder();
    	TreeSet<String> setInvertido = new TreeSet<>(comparadorInvertido);
    	setInvertido.addAll(arbolCadenas);
